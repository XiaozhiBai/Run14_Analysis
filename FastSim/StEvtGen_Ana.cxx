...
void StEvtGen_Ana::read(TString fileName)
{
  ...
  for(Int_t iEvent=0;iEvent<Tree->GetEntries();iEvent++)//
      ...
      for(Int_t iDaughter=0;iDaughter<Daughter->Ndaughter;iDaughter++)
	{
	  ...
	  TLorentzVector drMom(Daughter->dRPx[iDaughter],Daughter->dRPy[iDaughter],Daughter->dRPz[iDaughter],Daughter->dE[iDaughter]);
	  ...
	  if(abs(Daughter->dpdg[iDaughter])==11&&fabs(dMom.PseudoRapidity())<0.7)
	      ...
	      if(abs(Daughter->mpdg[iDaughter])==421)
		{
		  ...
		  mh2D0rDcaVspt[0]->Fill(dMom.Pt(),Daughter->d3DRdca[iDaughter]/10000.,weight_factor);

		  mh2D0DcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  mh2D0rDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  
		  mh2D0DcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
		  mh2D0rDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
	      ...
	      if(abs(Daughter->mpdg[iDaughter])==411)
		{
		  ...
		  mh2DplusrDcaVspt[0]->Fill(dMom.Pt(),Daughter->d3DRdca[iDaughter]/10000.,weight_factor);

		  mh2DplusDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  mh2DplusrDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  
		  mh2DplusDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
		  mh2DplusrDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);

		}
	      //Ds_plus
	      if(abs(Daughter->mpdg[iDaughter])==431)
		{
		  mh2DsplusrDcaVspt[0]->Fill(dMom.Pt(),Daughter->d3DRdca[iDaughter]/10000.,weight_factor);
		  mh2DsplusrDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  mh2DsplusrDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
		}
	      //Lc_plus
	      if(abs(Daughter->mpdg[iDaughter])==4122)
		{
		  mh2LcrDcaVspt[0]->Fill(dMom.Pt(),Daughter->d3DRdca[iDaughter]/10000.,weight_factor);
		  mh2LcrDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  mh2LcrDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
		}
	      //B0 
	      if(abs(Daughter->mpdg[iDaughter])==511)
		{
		  ...
		  mh2B0rDcaVspt[0]->Fill(dMom.Pt(),Daughter->d3DRdca[iDaughter]/10000.,weight_factor);


		  mh2B0DcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  mh2B0rDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  
		  mh2B0DcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
		  mh2B0rDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
	      ...
	      if(abs(Daughter->mpdg[iDaughter])==521)
		{
		  ...
		  mh2BplusrDcaVspt[0]->Fill(dMom.Pt(),Daughter->d3DRdca[iDaughter]/10000.,weight_factor);


		  mh2BplusDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  mh2BplusrDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor);
		  
		  mh2BplusDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
		  mh2BplusrDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor);
	      ...
	      if(abs(Daughter->mpdg[iDaughter])==111)
		{
		  ...
		  mh2pi0rDcaVspt[0]->Fill(dMom.Pt(),Daughter->d3DRdca[iDaughter]/10000.,weight_factor); 

		  mh2pi0DcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor); 
		  mh2pi0rDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor); 

		  mh2pi0DcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor); 
		  mh2pi0rDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor); 
	      ...
	      if(abs(Daughter->mpdg[iDaughter])==221)
		{
		  ...
		  mh2etarDcaVspt[0]->Fill(dMom.Pt(),Daughter->d3DRdca[iDaughter]/10000.,weight_factor); 

		  mh2etaDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor); 
		  mh2etarDcaVspt[1]->Fill(dMom.Pt(),Daughter->ddcaXY[iDaughter]/10000.,weight_factor); 

		  mh2etaDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor); 
		  mh2etarDcaVspt[2]->Fill(dMom.Pt(),Daughter->ddcaZ[iDaughter]/10000.,weight_factor); 
